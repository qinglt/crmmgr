...
<head>
    ...
    <script>
        ...
        function delete_inform(id,pageN){
            $.post(
                "${pageContext.request.contextPath}/gly/deleteInform",
                {"informId":id},
                function (data){
                    alert("删除成功");
                    pageJ(pageN);
    ...
    <div class="body_index">
        ...
        <div style="width: 1300px;height: auto">
            ...
            <div style="float: left">
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/gly/toAddInform">新增信息</a>
            </div>

            <div style="float: right">
                <%--查询信息--%>
                <form class="form-inline" action="${pageContext.request.contextPath}/gly/allInform" method="post" >
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach var="inform" items="${informPageInfo.list}">
                <tr>
                    ...
                    <td>
                        <a href="javascript:;" onclick="delete_inform('${inform.informId}','${informPageInfo.pageNum}')">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <%--页面跳转--%>
        <div>
            <form id="pageJump" action="${pageContext.request.contextPath}/gly/allInform" method="post">

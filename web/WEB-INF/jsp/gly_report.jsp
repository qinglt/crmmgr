...
<center>
    <div class="body_index1">
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach var="report" items="${cfmPageInfo.list}">
                <tr>
                    <td>${report.get("customFrom")}</td>
                    <td>${report.get("count")}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        ...
        <div>
            <form id="pageJump" action="${pageContext.request.contextPath}/gly/allReport" method="post">
                ...
                <a href="javascript:;" onclick="pageJ(${cfmPageInfo.prePage})">上一页</a>
                <a href="javascript:;" onclick="pageJ(${cfmPageInfo.nextPage})">下一页</a>
                <a href="javascript:;" onclick="pageJ(${cfmPageInfo.pages})">尾页</a>
            </form>
        </div>
